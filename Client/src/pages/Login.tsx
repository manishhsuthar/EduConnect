    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <div className="w-full max-w-md">
        ...
        <div className="glass rounded-2xl p-8 animate-fade-in">
          {/* Toggle */}
          <div className="relative flex bg-secondary rounded-lg p-1 mb-8">
            <div
              className={`absolute top-1 bottom-1 w-[calc(50%-4px)] bg-primary rounded-md transition-transform duration-300 ${
          ...
          <p className="text-muted-foreground text-center text-sm mb-6">
            {isLogin 
              ? 'Connect with thousands of educators and learners' 
              : 'Join the EduConnect community today'}
          </p>
